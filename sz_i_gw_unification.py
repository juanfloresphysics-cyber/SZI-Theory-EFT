"""
SZI Theory: Gravitational Wave Unification Simulation
...
Run: python sz_i_gw_unification.py
"""
...
plt.xlabel('Time (s)')
plt.ylabel('Strain h')
plt.title('SZI GW Unification: Noisy Chirp vs Template')
plt.legend()
plt.grid(True)
...
plt.tight_layout()
plt.savefig('sz_i_gw_unification_simulation.png')
plt.show()
print("Plot saved as 'sz_i_gw_unification_simulation.png'.")
